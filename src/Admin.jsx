    ...
    <div style={{ fontFamily: "'Courier New', monospace", background: "#0A0E1A", minHeight: "100vh", color: "#E2E8F0" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logout-btn { background: none; border: 1px solid #334155; border-radius: 4px; color: #64748B; cursor: pointer; font-family: 'Courier New', monospace; font-size: 0.62rem; padding: 0.35rem 0.8rem; transition: all 0.2s; }
