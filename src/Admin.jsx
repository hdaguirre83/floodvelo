    ...
    <div style={{ fontFamily: "'Courier New', monospace", background: "#0A0E1A", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
      ...
      <div style={{ background: "#0F172A", border: "1px solid #1E293B", borderRadius: 10, padding: "2.5rem 2rem", width: "100%", maxWidth: 380 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          {loginError && <div style={{ fontSize: "0.68rem", color: "#EF4444", background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", borderRadius: 4, padding: "0.5rem 0.75rem" }}>❌ {loginError}</div>}
    ...
    <div style={{ fontFamily: "'Courier New', monospace", background: "#0A0E1A", minHeight: "100vh", color: "#E2E8F0" }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "1.5rem" }}>
        ...
        {loading ? (
          ...
          const [velInput, setVelInput] = React.useState(s.velocity_ms || "");

          return (
            <div key={s.id} className="card" style={{ padding: "1rem 1.25rem", marginBottom: "0.75rem", display: "flex", flexWrap: "wrap", gap: "1rem", alignItems: "flex-start", opacity: updating===s.id ? 0.6 : 1, transition: "opacity 0.2s" }}>
              ...
              <div style={{ flex: 1, minWidth: 200 }}>
                ...
                {s.camera_type && <div style={{ fontSize: "0.62rem", color: "#334155" }}>📷 {s.camera_type} · {s.light_condition}</div>}
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", minWidth: 180, alignItems: "flex-end" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  />
                  <button className="save-btn" onClick={() => updateField(s.id, "velocity_ms", parseFloat(velInput) || null)}>
                    GUARDAR
                  </button>
                </div>
